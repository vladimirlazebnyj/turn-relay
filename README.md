...
> **Важно:** Авторы репозитория не несут ответственности за сторонние проекты.
...
Прежде чем начать, подготовь следующее:
...
<details><summary>Рекомендую tmux — чтобы процесс не умер при закрытии SSH</summary>
